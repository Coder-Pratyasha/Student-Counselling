  ...
  return (
    <div className="p-6 min-h-screen">
      ...
      <div className="overflow-x-auto">
       <div className="grid grid-cols-2 sm:grid-cols-4 md:grid-cols-6 lg:grid-cols-8 gap-3 bg-gray-200 p-4 font-bold text-gray-700 rounded-md min-w-[700px]">
          <p>#</p>
          <p>Student</p>
          <p>Payment</p>
          <p>Age</p>
        ...
        </div>
        {
          appointments.reverse().map((item, index) => (
            <div key={index} className="grid grid-cols-2 sm:grid-cols-4 md:grid-cols-6 lg:grid-cols-8 gap-4 items-center p-4 border-b hover:bg-gray-100 min-w-[700px]">
              <p>{index + 1}</p>
