...
const About = () => {
  return (
    <div className='bg-orange-100 p-5'>
      ...
      <div className='flex-1 border px-8 py-8  flex flex-col gap-5 text-[15px] hover:bg-orange-500 hover:text-white transition-all duration-300 text-gray-700 cursor-pointer'>
        <b>Trusted Experts</b>
